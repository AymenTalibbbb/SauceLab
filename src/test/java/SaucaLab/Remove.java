...
public class Remove {
    ...
    By btn_AddToCart = By.id("add-to-cart-sauce-labs-onesie");
    By btn_AddToCart1 = By.id("add-to-cart-sauce-labs-bike-light");
    By btn_AddToCart2 = By.id("add-to-cart-sauce-labs-bolt-t-shirt");
    By btn_AddToCart3 = By.id("add-to-cart-test.allthethings()-t-shirt-(red)");
    By btn_Remove = By.id("remove-sauce-labs-bike-light");
    ...
    public void remove_from_cart() {
        ...
        driver.findElement(btn_AddToCart3).click();
